                    ...
                    <form enctype="multipart/form-data" action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('name') }}" type="text" class="@error('name') is-invalid @enderror form-control-lg form-control" placeholder="Nama produk" name="name">
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('sku') }}" type="text" class="@error('sku') is-invalid @enderror form-control form-control-lg" placeholder="Tipe produk" name="sku">
                                @error('sku')
                                    <p class="invalid-feedback">{{ $message }}</p>
                                @enderror
                            </div>

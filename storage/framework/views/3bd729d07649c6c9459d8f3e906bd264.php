            ...
            <div class="col-md-10">
                <div class="card borde-0 shadow-lg my-4">
                    ...
                    <form enctype="multipart/form-data" action="<?php echo e(route('products.store')); ?>" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="" class="form-label h5">Nama produk</label>
...
unset($__errorArgs, $__bag); ?> form-control-lg form-control" placeholder="Nama produk" name="name">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label h5">Tipe produk</label>
...
unset($__errorArgs, $__bag); ?> form-control form-control-lg" placeholder="Tipe produk" name="sku">
                                <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="Description" class="form-control" name="description" cols="30" rows="5"><?php echo e(old('description')); ?></textarea>
                            </div>
                            <div class="mb-3">
...
</html><?php /**PATH D:\Nafiz\Kuliah\Tugas-Kuliah\Code\Antasena\SpecialTask\resources\views/products/create.blade.php ENDPATH**/ ?>